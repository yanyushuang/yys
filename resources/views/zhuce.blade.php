        ...
        <div class="login-box">
          <div class="am-tabs" id="doc-my-tabs">
            ...
            <div class="am-tabs-bd">
              ...
              <ul style="font-size:4px;margin:0px;padding:0px; list-style: none;"> 
                @if($errors -> all())
				...
				<!-- 邮箱注册 -->
        <form method="post" action="/zhuce/insert">
                	{{ csrf_field() }}
              ...
              <div class="am-tab-panel">
                <form method="post" action="/zhuce/insert2">
                	{{ csrf_field() }}
                  @if(session('error'))
                    {{ session('error') }}
                  @endif
					...
					<div class="verification">
						...
						<script type="text/javascript">
							$('#dyMobileButton').click(function(){
								...
								var phone = $('#phone').val();
							// 发送ajax 注册手机号
							$.get('/zhuce/phone',{phone:phone},function(msg){
                  if(msg.code == 2){
										alert(msg.msg);
										return;
									}else{
